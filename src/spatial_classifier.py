...
from spatial_classes.channel_aligned_same_block import channel_aligned_same_block_pattern
...
from spatial_classes.single_channel_alternated_blocks import single_channel_alternated_blocks_pattern
from spatial_classes.skip_4 import skip_4_pattern
from spatial_classes.tensor_aligned_single_block import tensor_aligned_single_block_pattern
...
SINGLE_CHANNEL_CLASSIFIERS = OrderedDict([
            (SpatialClass.SINGLE, single_pattern),
            (SpatialClass.SKIP_4, skip_4_pattern),
...
MULTI_CHANNEL_CLASSIFIERS = OrderedDict(
    [
        (SpatialClass.BULLET_WAKE, bullet_wake_pattern),
        (SpatialClass.SKIP_4, skip_4_pattern),
